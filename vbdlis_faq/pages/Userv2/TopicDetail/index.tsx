...
const TopicDetailPage: React.FC<TopicDetailPageProps> = ({
    ...
    const { topicChildId } = useParams<any>();
            ...
            >
                ...
                <Container className="container">
                    ...
                    >
                        ...
                        >
                            <Container>
                                <HD6 style={{ fontSize: '24px' }}>{Helper.getStateById(topicStore.topics, topicChildId)?.topicTitle}</HD6>
                            </Container>
...
export default inject('appStore')(observer(TopicDetailPage));

...
export const DISTANCE = {
    EN_ROUTE: { id: 1, name: 'Đang trên đường', color: '#3dcad4' },
    IDLE: { id: 2, name: 'Nhàn rỗi', color: '#bb99f7' },
};
...
// queryField: 'employee_organization_id'
// refDisplay: 'employee_organization_id'
// refField: 'employee_guid'
// refLayer: 'EMPLOYEE'

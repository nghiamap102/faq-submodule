...
class SketchMap extends Component
{
    ...
    {
        if (this.props.wfData.headerInfo.Id === event.incidentId)
        {
            const controls = [];
            let isDirty = false;
            const now = new Date();
    ...
    getSketchMap = () =>
    {
        const incident = this.props.wfData;
    ...
    handleApply = async () =>
    {
        ...
        const rs = await this.incidentSvc.commitSketchMap(data, this.sketchMapStore.controls.sketchMapCode,
            this.props.wfData.headerInfo.Id, this.sketchMapStore.controls.getSessionLock());
    ...
    handleCancel = async () =>
    {
        const rs = await this.incidentSvc.cancelSketchMap(this.props.wfData.headerInfo.Id, this.sketchMapStore.controls.getSessionLock());
            ...
            <FlexPanel>
                ...
                >
                    <ToolBarToggleButton
                        ...
                        onClick={(e) =>
                        {
                            this.handleSetMapDrawState.call(this, e, '');
                        }}
                    />
                    <ToolBarToggleButton
                        icon={'tool-label'}
                        ...
                        onClick={(e) =>
                        {
                            this.handleSetMapDrawState.call(this, e, 'Label');
                        }}
                    />
                    <ToolBarToggleButton
                        ...
                        onClick={(e) =>
                        {
                            this.handleSetMapDrawState.call(this, e, 'draw_point');
                        }}
                    />
                    <ToolBarToggleButton
                        icon={'tool-add-line'}
                        ...
                        onClick={(e) =>
                        {
                            this.handleSetMapDrawState.call(this, e, 'draw_line_string');
                        }}
                    />
                    <ToolBarToggleButton
                        ...
                        onClick={(e) =>
                        {
                            this.handleSetMapDrawState.call(this, e, 'draw_polygon');
                        }}
                    />
                </ToolBarToggleButtonGroup>

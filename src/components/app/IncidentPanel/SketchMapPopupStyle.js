...
class SketchMapPopupStyle extends Component
{
    ...
    {
        await this.sketchMapStore.updateControlDirectionPath(this.mapStore.map, value, this.directionService);
    };
...
SketchMapPopupStyle = inject('appStore')(observer(SketchMapPopupStyle));

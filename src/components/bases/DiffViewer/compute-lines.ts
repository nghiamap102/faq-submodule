 ...
 */
const computeDiff = (oldValue: string, newValue: string, compareMethod: string = DiffMethod.CHARS): ComputedDiffInformation =>
{
                    ...
                    if (nextDiff && nextDiff.added)
                    {
                        ...
                        if (nextDiffLines)
                        {
                            const {
                                ...
                                lineNumber,
                                type,
                            } = (getLineInformation(nextDiff.value, diffIndex, true, false, true) as LineInformation[])[0].right ?? {};
